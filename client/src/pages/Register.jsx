...
const Register = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      gender: "MALE",
      availability: [], // [F4] now an array for multi-select
      play_mixed: "DOES_NOT_MATTER",
      mode_selection: "COMPETITIVE",
      months_played: 0, // [M1] number of months played
    });
    const { login } = useAuth();
        ...
        >
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, play_mixed: e.target.value })
                }
              >
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  months_played: parseInt(e.target.value, 10) || 0,
                })
              }
              placeholder="e.g. 6"
            />
            ...
            <div className="space-y-2">
              ...
              {/* [F4] Multi-select availability */}
              <div className="flex flex-col gap-2 pt-1">
                {["MORNINGS", "EVENINGS", "WEEKENDS"].map((opt) => (
                  <label
                    key={opt}
                  ...
                  >
                    <input
                      type="checkbox"
                      className="w-4 h-4 accent-padel-green rounded"
                      ...
                      onChange={(e) => {
                        setFormData((prev) => ({
                          ...
                          availability: e.target.checked
                            ...
                            : prev.availability.filter((v) => v !== opt),
                        }));
                      }}
                    />
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, mode_selection: e.target.value })
                }
              >
          ...
          <p className="mt-8 text-center text-text-secondary text-sm font-medium">
            ...
            <button
              ...
              className="text-padel-green font-bold hover:underline"
            >
              Log In
            </button>
          </p>
