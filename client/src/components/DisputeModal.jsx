      ...
      <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
          <motion.div
            ...
            className="pointer-events-auto bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md border border-light-border mx-4"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
                <p className="text-xs text-amber-800">
                  <strong>Note:</strong> Frivolous disputes may result in
                  penalties. Only dispute if there's a genuine error.
                </p>
              </div>
