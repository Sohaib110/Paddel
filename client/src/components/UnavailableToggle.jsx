                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-[2.5rem] shadow-2xl p-10 w-full max-w-sm border border-light-border"
                        >
                            <div className="text-center mb-8">
                                ...
                                <h3 className="text-2xl font-black italic tracking-tighter text-text-primary uppercase">Going Stealth</h3>
